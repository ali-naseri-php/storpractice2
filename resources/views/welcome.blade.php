...
<html lang="en">
    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg">
            ...
            <a
                href="{{url('/new/kala')}}"
                class="absolute -ms-2 backdrop-blur-lg"
        ...
        <div class="d-flex p-2 margin=15px" style="align-items: center;justify-content: center;">
            <div><a href="{{url('/females')}}"><img src="./Main Page/1.png" width="400" style="margin: 15px "></a></div>
            <div><a href="{{url('/males')}}"><img src="./Main Page/2.png" width="400" style="margin: 15px"></a></div>
            <div><a href="{{url('/childishs')}}"><img src="./Main Page/3.png" width="400" style="margin: 15px"></a></div>
        </div>

        <br>

        <div class=" border border-success p-2 mb-3 text-center "
             style="background-color:pink; border-radius: 150px;"><b>جدیدترین محصولات</b></div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-6 col-md-4 col-xl-3 p-4 " style="align-items: center;justify-content: center;display: flex;flex-direction: column;">
                    <div class="card bg-light" style="width: 100%;">
                        <img
                            ...
                            alt="">
                        <div class="card-body">
                            <h6 class="card-title text-center fs-6 p-3 mb-2 bg-white text-dark rounded "> {{ $kala->name }}</h6>
                            <hr>
                            <a href="{{url('stores/'.$kala->id)}}">
                ...
                <br>
                <div class="d-flex p-4 margin=15px" style="align-items: center;justify-content: center;">
                    <div><img src="./Main Page/8.jpg" width="600" style="margin: 15px "></div>
                </div>
            </div>
        </div>
    </div>
