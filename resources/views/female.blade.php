...
<div class="container">
    ...
    <div class="mx-5 text-secondary fs-6">
        <p>فروشگاه اینترنتی پارمیدا > زنانه</p>
    </div>
    ...
    <div class="row">
        <div class="col-12 col-sm-4 col-md-3" style="align-items: center;justify-content: center;display: flex;flex-direction: column;">
            <a href="{{url('kalas/woman/شلوار')}}"><img
                    style="
              height: 150px;
            ...
            "
                    ...
                    title="شلوار جین"
                /></a>
            <div class="text-center p-2"><h6>شلوار جین</h6></div>
        </div>
        <div class="col-12 col-sm-4 col-md-3" style="align-items: center;justify-content: center;display: flex;flex-direction: column;">
            <a href="{{url('kalas/woman/مانتو')}}"><img
                    style="
              height: 150px;
              border: 1px solid black;
              border-radius: 150px;
            ...
            "
                    ...
                    title="مانتو"
                /></a>
            <div class="text-center p-2"><h6>مانتو</h6></div>
        </div>
        <div class="col-12 col-sm-4 col-md-3" style="align-items: center;justify-content: center;display: flex;flex-direction: column;">
            <a href="{{url('kalas/woman/بلوز')}}"> <img
                    style="
              height: 150px;
              border: 1px solid black;
              border-radius: 150px;
            ...
            "
                ...
                /></a>
            <div class="text-center p-2"><h6>بلوز آستین بلند</h6></div>
        </div>
        <div class="col-12 col-sm-4 col-md-3" style="align-items: center;justify-content: center;display: flex;flex-direction: column;">
            <a href="{{url('kalas/woman/شال')}}"> <img
                    style="
              height: 150px;
              border: 1px solid black;
              border-radius: 150px;
            ...
            "
                    ...
                    title="شال و روسری"
                /></a>
            <div class="text-center p-2"><h6>شال و روسری</h6></div>
        </div>
        <div class="col-12 col-sm-4 col-md-3" style="align-items: center;justify-content: center;display: flex;flex-direction: column;">
            <a href="{{url('kalas/woman/کیف')}}"><img
                    style="
              height: 150px;
              border: 1px solid black;
              border-radius: 150px;
            ...
            "
                    ...
                    title="کیف"
                /></a>
            <div class="text-center p-2"><h6>کیف</h6></div>
        </div>
        <div class="col-12 col-sm-4 col-md-3 " style="align-items: center;justify-content: center;display: flex;flex-direction: column;">
            <a href="{{url('kalas/woman/تیشرت')}}"> <img
                    style="
              width: 151px;
              height: 160px;
              border: 1px solid black;
        ...
        <div  class="col-12 col-sm-4 col-md-3" style="align-items: center;justify-content: center;display: flex;flex-direction: column;">
            <a href="{{url('kalas/woman/ژاکت')}}"> <img
                    style="
              height: 150px;
              border: 1px solid black;
              border-radius: 150px;
            ...
            "
                    class="w-200"
                    src="./female/7.jpg"
                    alt="ژاکت و پلیور بافت"
                    title="ژاکت و پلیور بافت"
                /></a>
            <div class="text-center p-2"><h6>ژاکت و پلیور بافت</h6></div>
        </div>
        <div class="col-12 col-sm-4 col-md-3" style="align-items: center;justify-content: center;display: flex;flex-direction: column;">
            <a href="{{url('kalas/woman/ورزشی')}}"><img
                    style="
              height: 150px;
              border: 1px solid black;
              border-radius: 150px;
            ...
            "
                    ...
                    title="لباس باشگاهی"
                /></a>
            <div class="text-center p-2"><h6>لباس باشگاهی</h6></div>
        </div>
        <div class="col-12 col-sm-4 col-md-3" style="align-items: center;justify-content: center;display: flex;flex-direction: column;">
            <a href="{{url('kalas/woman/کاپشن')}}"><img
                    style="
              height: 150px;
              border: 1px solid black;
              border-radius: 150px;
            ...
            "
                    ...
                    src="./female/9.jpg"
                    alt="کاپشن و بارانی"
                    title="کاپشن و بارانی"
                /></a>
            <div class="text-center p-2"><h6>کاپشن و بارانی</h6></div>
        </div>
        <div class="col-12 col-sm-4 col-md-3" style="align-items: center;justify-content: center;display: flex;flex-direction: column;">
            <a href="{{url('kalas/woman/کمربند')}}"><img
                    style="
              height: 150px;
              border: 1px solid black;
              border-radius: 150px;
            ...
            "
                    ...
                    title="کمربند"
                /></a>
            <div class="text-center p-2"><h6>کمربند</h6></div>
        </div>
        <div class="col-12 col-sm-4 col-md-3" style="align-items: center;justify-content: center;display: flex;flex-direction: column;">
            <a href="{{url('kalas/woman/اسکرانچی')}}"><img
                    style="
              height: 150px;
              border: 1px solid black;
              border-radius: 150px;
            ...
            "
                    ...
                    title="اسکرانچی"
                /></a>
            <div class="text-center p-2"><h6>اسکرانچی</h6></div>
        </div>
        <div class="col-12 col-sm-4 col-md-3" style="align-items: center;justify-content: center;display: flex;flex-direction: column;">
            <a href="{{url('kalas/woman/کلاه')}}"><img
                    style="
              height: 150px;
              border: 1px solid black;
              border-radius: 150px;
